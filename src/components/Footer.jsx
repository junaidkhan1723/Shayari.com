          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className="mb-4">
              ...
              <p className="text-light opacity-75 mb-4">
                ...
                thoughts, and feelings through the timeless art of Shayari.
              </p>
            ...
            <div className="col-12 col-md-6 text-center text-md-end mt-2 mt-md-0">
              <div className="d-flex justify-content-center justify-content-md-end align-items-center gap-3">
                ...
                <div className="d-flex gap-2">
                  <button className="btn btn-sm btn-outline-light opacity-75" style={{ fontSize: '0.8rem' }}>
                    हिंदी
                  </button>
                  <button className="btn btn-sm btn-outline-light opacity-75" style={{ fontSize: '0.8rem' }}>
                    اردو
                  </button>
                  <button className="btn btn-sm btn-light text-dark" style={{ fontSize: '0.8rem' }}>
                    English
                  </button>
                </div>
              </div>
